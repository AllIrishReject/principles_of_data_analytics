...
This repository contains solutions to a series of problems for a Principles of Data Analytics module. It demonstrates key data analytics techniques including data loading, descriptive statistics, data visualization, and basic modelling using Python libraries such as pandas, numpy, and matplotlib.
